...
function aprekins() {
  ...
  if (!vards.match(/^\s[a-zA-Zā-žĀ-Ž\s]*$/)) {//if (!vards.match(/^[a-zA-Z\s]*$/)) neļau ievadīt piemēram Laimonis1, bet tikai var Vārdu Laimonis un atļauj atstarpes rakstīt un neatpazīst garumzīmes
    ...
    //(/^\s[a-zA-Zā-žĀ-Ž\s]*$/) šī daļa (/^\s pasaka, ka nedrīkst būt tukšuma zīme//
